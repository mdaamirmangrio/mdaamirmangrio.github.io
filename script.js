...
const certificates = [
  {
    imagePath: "certificates/wd.jpg",   
    title: "Website Development",
    institute: "Sukkur IBA University",
    completionDate: "Nov - Dec 2024",
  },
  {
    imagePath: "certificates/java.jpg",
    title: "Java Programming",
    institute: "Sukkur IBA University",
    completionDate: "Jan - aug 2025",

  },
    {
    imagePath: "certificates/google.jpg",
    title: "AI Essentials",
    institute: "Google",
  ...
  certificates.forEach((certificate) => {
    ...
    certificateCard.innerHTML = `
            <div class="certificate-image">
                <img src="${certificate.imagePath}" alt="${certificate.title} Certificate" class="certificate-img">
                <div class="certificate-overlay">
                    <i class='bx bx-search-alt'></i>
                </div>
            </div>
            <div class="certificate-content">
                <h3 class="certificate-title gradient-text">${certificate.title}</h3>
